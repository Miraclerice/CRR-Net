% =======================================================================================
% SPM12 Automated Batch Script: Old Normalise (Estimate & Separate Write) for Mindboggle
% =======================================================================================
...
for i = 1:num_pairs
    ...
    matlabbatch{1}.spm.tools.oldnorm.est.eoptions.smosrc = 5;
    matlabbatch{1}.spm.tools.oldnorm.est.eoptions.smoref = 5;
    % subj none mni
    matlabbatch{1}.spm.tools.oldnorm.est.eoptions.regtype = 'none'; 
    matlabbatch{1}.spm.tools.oldnorm.est.eoptions.cutoff =  10;
    matlabbatch{1}.spm.tools.oldnorm.est.eoptions.nits = 50;
    matlabbatch{1}.spm.tools.oldnorm.est.eoptions.reg = 0.1;
