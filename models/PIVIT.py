...
Original paper:
Ma T, Dai X, Zhang S, Wen Y (2023) PIViT: Large deformation image registration with pyramid-iterative vision transformer. In: Greenspan H, Madabhushi A, Mousavi P, Salcudean S, Duncan J, Syeda-Mahmood T, Taylor R (eds) International Conference on Medical Image Computing and Computer-Assisted Intervention (MICCAI 2023), Springer Nature Switzerland, Vancouver, BC, Canada, 8-12 October 2023. https://doi.org/10.1007/978-3-031-43999-5_57
...
class SwinTransformerBlock3D(nn.Module):
    ...
    def forward(self, x, mask_matrix):
        ...
        if self.use_checkpoint:
            ...
            x = checkpoint(self.forward_part1, x, mask_matrix)
        else:
        ...
        if self.use_checkpoint:
            ...
            x = x + checkpoint(self.forward_part2, x)
        else:
...
class pivit(nn.Module):
    # @store_config_args
    def __init__(self, size=(80, 96, 80), in_channel=1, first_channel=32, **kwargs):
