...
Original paper:
Liu Y, Zuo L, Han S, Xue Y, Prince JL, Carass A (2022) Coordinate translator for learning deformable medical image registration. In: Li X, Lv J, Huo Y, Dong B, Leahy RM, Li Q (eds) International Workshop on Multiscale Multimodal Medical Imaging (MMMI 2022), Springer Nature Switzerland, Singapore, 22-22 September 2022. https://doi.org/10.1007/978-3-031-18814-5_10
...
class Im2grid(nn.Module):
    def __init__(self, inshape=(160,192,160), flow_multiplier=1.,in_channel=1, channels=4, **kwargs):
