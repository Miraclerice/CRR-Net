...
Original paper:
Kang M, Hu X, Huang W, Scott MR, Reyes M (2022) Dual-stream pyramid registration network. Med Image Anal 78102379. https://doi.org/10.1016/j.media.2022.102379
...
class PRNetplusplus(nn.Module):
    def __init__(self, size=(80, 96, 80), in_channel=1, first_channel=8, **kwargs):
